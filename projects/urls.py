...
urlpatterns = [
    ...
    path('projects/<int:pk>/complete/', views.ProjectCompleteView.as_view(), name='complete'),
    path('projects/<int:pk>/toggle-participate/', views.ProjectParticipateView.as_view(), name='participate'),
    path('projects/<int:pk>/favorite/', views.ProjectFavoriteView.as_view(), name='favorite'),
    ...
    path('projects/<int:pk>/skills/<int:skill_id>/remove/', views.skill_remove, name='skill_remove'),
]